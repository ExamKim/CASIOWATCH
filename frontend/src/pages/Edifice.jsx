...
const Edifice = () => {
    ...
    useEffect(() => {
        ...
        const loadHero = async () => {
            try {
                const res = await productsApi.getProducts({ category: 'Edifice', page: 1, limit: 1 });
                if (!mounted) return;
            ...
            <section className="catalog-hero" style={{ backgroundImage: `linear-gradient(120deg, rgba(8, 8, 8, 0.96), rgba(8, 8, 8, 0.62)), url("${heroImage}")` }}>
                ...
                <div className="catalog-hero-inner">
                    <div className="catalog-hero-copy">
                        <p className="catalog-subheading">Bộ sưu tập Edifice</p>
                        <h1>Edifice Collection</h1>
                        <p>Khám phá đồng hồ Edifice - công nghệ và phong cách.</p>
